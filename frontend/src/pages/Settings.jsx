  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-8 text-center">
        <div className="w-16 h-16 rounded-full bg-white/[0.03] flex items-center justify-center mx-auto mb-4 text-slate-500">
        ...
        <p className="text-slate-400">Settings page is currently under development.</p>
      </div>
    </div>
  );
}
